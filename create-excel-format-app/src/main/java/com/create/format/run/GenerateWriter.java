...
public class GenerateWriter {
	...
	// Initializing employees data to insert into the excel file
		...
		public static void main(String[] args) throws IOException, InvalidFormatException {
			...
			/*** TITLE */
			Sheet sheet = workbook.createSheet("Fondos Mutuos");
			...
			amountCellStyle.setBorderBottom(BorderStyle.THIN);
			
			//byte[] rgbBorder = new byte[]{(byte)128, (byte)128, (byte)128};
			//XSSFFont xssfFontBorder = (XSSFFont)amountCellStyle;
			//xssfFontBorder.setColor(new XSSFColor(rgbBorder, null));
			//amountCellStyle.setBottomBorderColor(IndexedColors.BLACK.getIndex());
			//amountCellStyle.setBottomBorderColor(color);
			...
			for (Movimientos objMovim : movimientos) {
				...
				row.createCell(2).setCellValue(objMovim.getFondo());
				row.createCell(3).setCellValue(objMovim.getDescripcion());
				row.createCell(4).setCellValue(objMovim.getDetalle());
				row.createCell(5).setCellValue(objMovim.getNumeroDeCuotas());
				row.createCell(6).setCellValue(objMovim.getValorCuota());
		...
		private static void addImage(Workbook wb , Sheet sheet) {
			...
			try {
				  ...
				  // Sheet sheet = wb.createSheet("My Sample Excel");
				   ...
				   InputStream inputStream = new FileInputStream("E:/Zoluxiones/Proyecto/3_Workspaces/create-excel-format-app/src/main/java/com/create/format/file/logo_EMPRESA.png");
				  ...
				  // FileOutputStream fileOut = null;
				   //fileOut = new FileOutputStream("E:/Zoluxiones/Proyecto/3_Workspaces/create-excel-format-app/src/main/java/com/create/format/file/myPicFile.xlsx");
				   //wb.write(fileOut);
				   //fileOut.close();
				   //wb.close();
